 ...
 */
export function loadCensusData(variable: string) {
 ...
 */
export function styleFeature(feature: google.maps.Data.Feature) {
 ...
 */
export function mouseInToRegion(e: any) {
  // set the hover state so the setStyle export function can change the border
 ...
 *
 */
export function mouseOutOfRegion(e: any) {
